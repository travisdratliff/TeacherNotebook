...
struct NewTemplateView: View {
    ...
    @Trimmed var textFieldOrder = ""
    @Trimmed var templateTitle = ""
    @Trimmed var textFieldTitle = ""
    @Trimmed var dropDownTitle = ""
    @Trimmed var dropDownOption = ""
            ...
            List {
                ...
                Section {
                    ...
                    HStack {
                        ...
                        .buttonStyle(.borderless)
                        .disabled(dropDownOption.isEmpty)
                    }
                    .padding(.horizontal)
                    .listRowInsets(EdgeInsets())
